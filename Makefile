#
# OMNeT++/OMNEST Makefile for SmartSubstation
#
...
OBJS = $O/src/apps/DifferentialProtectionApp.o $O/src/apps/SvGeneratorApp.o $O/src/apps/TrafficKpiReporter.o $O/src/apps/VideoFragmentApp.o
